...
XTENSA_TOOLS_ROOT ?= /home/andrei/esp-open-sdk/xtensa-lx106-elf/bin

# base directory of the ESP8266 SDK package, absolute
SDK_BASE	?= /home/andrei/esp-open-sdk/sdk
...
MODULES	= src src/drivers src/contikijson
EXTRA_INCDIR = $(SDK_BASE)/../extra/include

# libraries used in this project, mainly provided by the SDK
#LIBS = c gcc hal phy pp net80211 lwip wpa main crypto
LIBS = c mgcc hal phy pp net80211 lwip wpa main crypto ssl
...
LD_SCRIPT	:= $(addprefix -Tld/,$(LD_SCRIPT))

INCDIR			:= $(addprefix -I,$(SRC_DIR))
EXTRA_INCDIR	:= $(addprefix -I,$(EXTRA_INCDIR))
#MODULE_INCDIR	:= $(addsuffix /src/fonts,$(INCDIR))
...
$1/%.o: %.c
	...
	$(Q) $(CC) $(INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS)  -c $$< -o $$@
endef

.PHONY: all checkdirs clean flash flashall flashinit rebuild

all: checkdirs $(TARGET_OUT)

$(TARGET_OUT): $(APP_AR)
	$(vecho) "LD $@"
	$(Q) $(LD) -L$(SDK_LIBDIR) -Llib $(LD_SCRIPT) $(LDFLAGS) -Wl,--start-group $(LIBS) $(APP_AR) -Wl,--end-group -o $@
	$(vecho) "------------------------------------------------------------------------------"
	$(vecho) "Section info:"
	$(Q) $(OBJDUMP) -h -j .data -j .rodata -j .bss -j .text -j .irom0.text -j .font0.text $@
	$(vecho) "------------------------------------------------------------------------------"
